...
describe('dashboard trace view JSON', () => {
  ...
  it('includes policies in the trace JSON envelope', async () => {
    const snapshot = makeSnapshot({
      ...
      constraints: [{
        id: 'constraint:TRACE',
        description: 'Traceability needs a capped scope',
        threshold: '4 tasks',
        unit: 'scope',
        targetIds: ['req:TRACE'],
      }],
      assumptions: [{
        id: 'assumption:TRACE',
        description: 'Traceability packet remains stable',
        validated: false,
        targetIds: ['task:TRACE'],
      }],
      risks: [{
        id: 'risk:TRACE',
        description: 'Traceability gaps can stall completion',
        likelihood: 0.8,
        impact: 0.5,
        targetIds: ['req:TRACE'],
      }],
      spikes: [{
        id: 'spike:TRACE',
        timeboxHours: 3,
        outcome: 'Validated the missing links',
        targetIds: ['risk:TRACE', 'assumption:TRACE'],
      }],
    });
    ...
    expect(ctx.jsonOut).toHaveBeenCalledWith({
      ...
      data: {
        ...
        failingCriteria: [],
        planningGaps: {
          unvalidatedAssumptionIds: ['assumption:TRACE'],
          unmitigatedRiskIds: ['risk:TRACE'],
          riskHotspots: [{
            id: 'risk:TRACE',
            likelihood: 0.8,
            impact: 0.5,
