...
- **Substrate floor raised to `@git-stunts/git-warp@^14.11.0`** — XYPH now consumes the published substrate release that adds braid descriptors to the working-set substrate and makes co-present overlay visibility a released dependency rather than a local assumption.
