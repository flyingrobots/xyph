...
- **Scrollable cockpit panes now show explicit vertical scrollbars with interaction fade** — the worklist and inspector lanes now render a real track with arrows and thumb when navigation wakes them, then fade back out once interaction stops. That keeps scrollability discoverable without leaving full-strength rails burning in constantly.
