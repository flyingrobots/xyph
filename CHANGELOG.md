...
- **Substrate floor raised to `@git-stunts/git-warp@^14.12.0`** — XYPH now consumes the published substrate release that makes braid-backed debugger truth explicit in git-warp and keeps the XYPH worldline slice pinned to a real released substrate version.
