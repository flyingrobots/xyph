...
- **Substrate floor raised to `@git-stunts/git-warp@^14.15.0`** — XYPH now consumes the published substrate release that adds scoped visible-state comparison and transfer facts, keeping durable comparison/collapse governance pinned to a real released substrate version.
